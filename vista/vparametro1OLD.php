...
?>
<center>
<form name="form1" action="vparametro.php?pac=102" method="post" >
	<table width="400">
        <tr>
  ...
  <div align="center" id="tabint">
    ...
    <tr>           
		<td class="style2" align="center"><?php echo $dat[$i]['codpar']?><input type="hidden" name="del" value=<?php echo $dat[$i]['codpar']?>>
            ...
            <td align="center"><a href="vparametro.php?pr=<?php echo $dat[$i]['codpar'] ?>&pac=102&up=11"><img border=0 src="../img/editar.png" width="16" height="16" /></a></td>    
		</tr>
...
<form name="form3" action="vparametro.php?pac=102" method="post" >
	<table width="400">
        <tr>
        	<td colspan="2" align="center">
  ...
  <div align="center" id="tabint"> 
    ...
    <tr>           
		<td class="style2" align="center"><input type="submit" name="del2" value=<?php echo $dat2[$i]['codval']?>>
            ...
            <td align="center"><a href="vparametro.php?pr=<?php echo $dat2[$i]['codval'] ?>&pac=102&up=11&ed=1&prr=<?php echo $dat2[$i]['codpar'] ?>"><img border=0 src="../img/editar.png" width="16" height="16" /></a></td>    
		</tr>
	<?php  }  ?>
