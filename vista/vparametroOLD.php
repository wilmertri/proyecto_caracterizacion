  ...
  <div align="center" id="tabint">
    ...
    <tr>           
		<td class="style2" align="center"><?php echo $dat[$i]['codpar']?><input type="hidden" name="del" value=<?php echo $dat[$i]['codpar']?>>
            ...
            <td align="center"><a href="vparametro1.php?pr=<?php echo $dat[$i]['codpar'] ?>&pac=102&up=11&ed=0"><img border=0 src="../img/editar.png" width="16" height="16" /></a></td>    
		</tr>
...
<form id="form4" name="form3" method="get" action="" onSubmit="return confirm('¿Desea eliminar?')">
  <div align="center" id="tabint">
    	...
    	<table width="550" align="center" border="1" cellspacing="0" cellpadding="4" style="margin-left:200px" >
    ...
    <tr>           
		<td class="style2" align="center"><input type="submit" name="del2" value=<?php echo $dat2[$i]['codval']?>>
            ...
            <td align="center"><a href="vparametro1.php?pr=<?php echo $dat2[$i]['codval'] ?>&pac=102&up=11&ed=1&prr=<?php echo $dat2[$i]['codpar'] ?>"><img border=0 src="../img/editar.png" width="16" height="16" /></a></td>    
		</tr>
