...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-04-2015 a las 08:02:02
...
ALTER TABLE `tbexplaboral`
  ADD CONSTRAINT `tbexplaboral_ibfk_1` FOREIGN KEY (`numdocper`) REFERENCES `tbdatospersona` (`idpersona`) ON UPDATE CASCADE;
...
ALTER TABLE `tbingresoext`
  ...
  ADD CONSTRAINT `tbingresoext_ibfk_3` FOREIGN KEY (`numdocper`) REFERENCES `tbdatospersona` (`idpersona`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `tbnegocio`
--
ALTER TABLE `tbnegocio`
  ADD CONSTRAINT `tbnegocio_ibfk_1` FOREIGN KEY (`numdocper`) REFERENCES `tbdatospersona` (`idpersona`) ON UPDATE CASCADE;
