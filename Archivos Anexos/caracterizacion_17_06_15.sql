...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-06-2015 a las 00:35:59
...
INSERT INTO `tbcapacitacion` (`codcapper`, `nomcap`, `entcap`, `titcapper`, `opicapper`, `idpersona`) VALUES
(3, 'Excel avanzado II', 'ENID', 'Manejo en herramientas de EXCEL avanzado', 'No se', 8),
(4, 'bbb', 'bvbb', 'zzzz', 'dddd', 8),
(5, 'gestion', 'enid', 'tecnico', 'No', 9),
(6, 'gestion 2', 'enid 2', 'tecnico 2', 'No', 4),
(7, 'bbb', 'bbb', 'bbb', 'bbb', 4);
...
(4, '20506030', 1, 25175, 'AN', 'FE', 'VT', '', 3, 'CRA 4 # 12 - 87', 1, 1, '', '', '8706959', '', 25175, '1991-07-19', NULL, NULL, NULL, 5, NULL, 12, 1, '500000.00', 14, 0, 95, 0, 0, NULL, 0, '', 0, 25, 0, NULL, 0, NULL, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 102, 14, 106, 0, 0, 0, 61, 55, 70, 77, 3, 2, 2, 87, 130, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, NULL, NULL, NULL, NULL, ''),
...
(7, '1072489444', 1, 15097, 'EDWIN', 'JORGE', 'GONZALES', 'BARRIOS', 3, 'CRA 7 # 78', 1, 1, 'CHILACOS', 'LOS ZIPAS', '8851247', '3104567897', 17380, '1985-01-02', NULL, NULL, NULL, 6, NULL, 11, 2, '1000000.00', NULL, 0, 0, 0, 0, NULL, 0, '', 0, 25, 0, NULL, 116, NULL, NULL, 3, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 105, 1, 105, 113, 120, 127, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 130, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 555, NULL, NULL, NULL, NULL, NULL, 'Como asistente domiciliario'),
(8, '1075489111', 1, 25175, 'JULIAN', '', 'GONZALES', 'CAMARGO', 3, 'CLL 29 # 30 - 20', 1, 1, 'CHILACOS', '', '8626988', '3125407320', 11001, '1990-01-01', NULL, NULL, NULL, 6, NULL, 11, 3, '500000.00', 13, 0, 0, 0, 0, NULL, 0, '', 0, 25, 0, NULL, 114, NULL, NULL, 3, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 104, 2, 105, 0, 118, 105, 61, 56, 70, 84, 5, 2, 3, 88, 130, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1002, NULL, NULL, NULL, NULL, NULL, 'Como asistente'),
(9, '1070123456', 1, 23555, 'SOFIA', '', 'VARGAS', '', 4, 'CRA 56', 1, 1, '', '', '8879584', '', 94885, '1994-02-01', NULL, NULL, NULL, 5, NULL, 12, 1, '0.00', NULL, 0, 0, 0, 0, NULL, 0, '', 0, 25, 0, NULL, 113, NULL, NULL, 2, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 102, 14, 104, 103, 121, 106, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 130, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10001, NULL, NULL, NULL, NULL, NULL, 'Asesor comercial de la empresa HTC');
...
(4, 'adasd', 'asdasd', '456546.00', 9),
(5, 'Asistente de produccion', 'Oficios varios', '750000.00', 7),
(6, 'bbbb', 'bbbb', '455555.00', 7);
...
--
-- Volcado de datos para la tabla `tbingreso`
--

INSERT INTO `tbingreso` (`coding`, `tipoing`, `ing`, `idpersona`) VALUES
(1, 185, '100000.00', 7),
(2, 189, '50000.00', 7);
...
--
-- Volcado de datos para la tabla `tbingresoext`
--

INSERT INTO `tbingresoext` (`codingext`, `tipingext`, `ingext`, `desingext`, `idpersona`) VALUES
(1, 2, '2000', 'asdasd', 7),
(2, 5, '100000', 'aaaa', 7);
...
(7, 7, 'venta de alimentos2', 'de alimentos', '179', 'Cra 4', 102),
(8, 7, 'venta de manillas', 'de manufactura', '174', 'cra 5', 103);
...
CREATE TABLE IF NOT EXISTS `tbobservaciones` (
  `codobservacion` int(11) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(500) NOT NULL,
  `fecha` datetime NOT NULL,
  `idpersona` int(11) NOT NULL,
  PRIMARY KEY (`codobservacion`),
  KEY `tbobservaciones_ibfk_1` (`idpersona`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
...
(1, 'Tiene que trabajar o buscar trabajo'),
(2, 'No tiene dinero para sus estudios'),
(3, 'No hay cupo'),
(4, 'No hay centro educativo cercano'),
(5, 'Por cambio de residencia / desastre natural'),
(6, 'No le gusta o no quiere estudiar'),
(7, 'Debe encargarse de los oficios del hogar'),
(8, 'Por embarazo o tiene un hijo'),
(9, 'Por enfermedad'),
(10, 'Problemas de seguridad/presencia de pandillas'),
(11, 'Problemas de abuso (matoneo)'),
(12, 'Por desplazamiento forzado'),
(13, 'No tiene acceso a la educación especial'),
(14, 'Otra');
...
(9, 'Ninguno', 4),
(10, 'Preescolar', 4),
(11, 'Básica primaria (1.o - 5.o)', 4),
(12, 'Básica secundaria (6.o - 9.o)', 4),
(13, 'Casa', 5),
(14, 'Apartamento', 5),
(15, 'Si', 6),
(16, 'No', 6),
...
(172, 'Otra', 38),
(173, 'Menor a 6 meses', 39),
(174, 'Menor a un año', 39),
(175, 'Un (1) Año', 39),
(176, 'Dos (2) Años', 39),
(177, 'Tres (3) Años', 39),
(178, 'Cuatro (4) Años', 39),
(179, 'Cinco (5) Años', 39),
(180, 'Más de cinco (5) Años', 39),
(181, 'Media (10.o - 13.o)', 4),
(182, 'Superior o universitaria', 4),
(183, 'Postgrado', 4),
(184, 'No sabe, no informa', 4),
(185, 'Trabajo Formal', 40),
(186, 'Trabajo Informal', 40),
(187, 'Negocio Propio', 40),
(188, 'Ayuda Económica de Familiares o de Amigos', 40),
(189, 'Subsidios del Gobierno', 40),
(190, 'Apoyo Económico de ONGs', 40),
(191, 'Otro', 40);
